...
public class ArticleDetailFragment extends Fragment implements
    ...
    public void extendImageToDrawOverStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            /** Also change the height for toolbar, as it will extend onto status bar **/
            int result = 0;
            int actionBarHeight = 0;
            int resourId = getActivityCast().getResources().getIdentifier("status_bar_height","dimen", "android");
            if(resourId>0){
                result = getActivityCast().getResources().getDimensionPixelSize(resourId);
            }
            Toolbar mToolbar = (Toolbar) mRootView.findViewById(R.id.toolbar);
            TypedValue tv = new TypedValue();
            if (getActivityCast().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            ...
            layoutParams.height = actionBarHeight + result/2;
            mToolbar.setLayoutParams(layoutParams);
            mToolbar.setPadding(0, result/2, 0, 0);
    ...
    private void bindViews() {
        ...
        collapsingToolbarLayout.setCollapsedTitleTextAppearance(R.style.toolbarTextTheme);
        collapsingToolbarLayout.setExpandedTitleTextAppearance(R.style.toolbarTextTheme);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset >=0 && scrollRange + verticalOffset <= 192) {
